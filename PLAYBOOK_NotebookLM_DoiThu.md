...
1. Nạp URL **Zenn** + **Ink Explainer** vào NotebookLM, chạy prompt phân tích ở bước 3, so kết quả với hệ thống `HE_THONG_KichBan_v2_14Video.md` ⛔ *(v1 đã chết — v2 bác 4 luật của nó)*. Xem nó bóc được gì mình chưa có.
