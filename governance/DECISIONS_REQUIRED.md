...
| **D-20** | Tỉ lệ THẺ DẠY HỌC là bao nhiêu? | `validate_shots.py` ép **30-45%**; skill `sketchapiens-chia-shot` PHẦN 4 nhắm **~50%**. Hai nguồn, hai con số, cả hai đều nói là đo từ đối thủ | ✅ **ĐÃ GIẢI 07/08/2026 bằng BẰNG CHỨNG, không phải bằng ý kiến** → **40% thẻ / 60% cảnh**. Lời giải nằm sẵn trong kho mà không ai biết: `kho/3_bangchung/NGUPHAP_HINH_DoLai_ToanBo_2026-07-30.md` đo **1.090 khung bằng máy** (Ink **41%** · Mack **36%**) và **thay thế** file 96-khung-đếm-mắt mà skill đang trích. → `validate_shots.py` (30-45%) **đúng**; skill đã sửa. V17 dựng trên số sai và ra **75% thẻ** |
