# -*- coding: utf-8 -*-
"""
Video12 pipeline: per-shot TTS (Josh) -> ghép ảnh khớp tiếng -> why-are-your-feet-so-weak-when-a-cavemans-werent.mp4
TTS chạy trên SHOTLINES_FULL.txt (255 dòng-shot = 255 ảnh = 255 clip, sync 100%).
...
Ảnh đặt trong images/ đặt tên 001.png..255.png theo đúng thứ tự shot.
"""
...
OUT    = os.path.join(HERE, "why-are-your-feet-so-weak-when-a-cavemans-werent.mp4")
