...
## Luật
- **Không ghi đè.** Tạo `03-script/vNNN-after-<vòng>.md`, giữ nguyên mọi version cũ.
...
- Không đụng `approved.md`, `published.md`.
...
5. **Không** đặt `script_approved`. Chỉ chủ duyệt mới được.
