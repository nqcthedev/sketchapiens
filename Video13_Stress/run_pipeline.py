# -*- coding: utf-8 -*-
"""
Video13 pipeline: per-shot TTS (Josh) -> ghép ảnh khớp tiếng -> why-does-stress-make-you-sick-when-a-cavemans-didnt.mp4
TTS chạy trên SHOTLINES_FULL.txt (253 dòng-shot = 255 ảnh = 255 clip, sync 100%).
Key đọc từ ~/.config/ghepvideo/elevenlabs.key lúc chạy (KHÔNG lưu trong file).
Dùng:
  python3 run_pipeline.py tts [N]   # N = giới hạn test (bỏ trống = full 255)
...
Ảnh đặt trong images/ đặt tên 001.png..253.png theo đúng thứ tự shot.
"""
...
OUT    = os.path.join(HERE, "why-does-stress-make-you-sick-when-a-cavemans-didnt.mp4")
