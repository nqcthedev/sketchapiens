...
2. **REFERENCE SHEET / "mặc đồ"** — **đính ảnh base** → dán prompt costume (trong `Prompts_NhanVat_Kenh.md`) → ra **sheet 1 ảnh** gồm: thân trước/nghiêng/sau + đầu turnaround + **4 biểu cảm**. *(Chính là cách ra `@MODERNYOU`.)* Đây vừa là **model sheet** vừa là **expression sheet**.
...
- [ ] Đánh **✅** trong registry (`CastBible_DienVien.md`).
