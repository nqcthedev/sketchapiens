# LUẬT CHỌN ĐỀ TÀI — file luật tầng 1

> **Dựng 07/08/2026** bằng cách tách khỏi `00_LUAT_HIEN_HANH.md`.
> Trước đó khâu chọn đề tài **không có file luật tầng 1 nào** — chỉ có bằng chứng tầng 3
> *(`kho/3_bangchung/BANG_CAU_TatCa_CuNo_2026-07-29.md`)*, mà tầng 3 **không được quyền phán**.
> Đó là một lỗ hổng thật trong bản đồ kho, không phải chuyện sắp xếp cho gọn.
