...
| **3** | 16 ẩn dụ · 8 truyện chêm · 4 luật lách kiểm duyệt | ✅ `../2_nguyenlieu/KHO_AnDu_TruyenChem_LachLuat.md`. Tra 4 mỏ neo → **2 sai số** (Borneo 2023→2022 · Diocles 5 tỷ→15 tỷ), 1 chi tiết không có nguồn (xương hươu hang Gough) |
...
Ba lệnh cho vòng tiếp theo nay nằm ở **`../4_luutru/LENH_NotebookLM_ChuaLam.md`** (kèm 5 URL dán thẳng).
